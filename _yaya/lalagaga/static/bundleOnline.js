...
var _Blog = __webpack_require__(82);
...
var Blog = function (_React$Component) {
	...
	_createClass(Blog, [{
		...
		value: function componentWillMount() {
			...
			fetch('http://127.0.0.1:5000/getCommit', fetchConfig).then(function (response) {
		...
		value: function testFetch() {
			...
			var fetchConfig = {
				...
				headers: myHeaders,
				mode: 'cors',
				body: JSON.stringify({ title: "lala" })
			};
			fetch('http://127.0.0.1:5000/addCommit', fetchConfig).then(function (response) {
				return response.json();
			}).then(function (data) {
				console.log(data);
			});
