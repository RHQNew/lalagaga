...
*/
var aa=__webpack_require__(0),l=__webpack_require__(12),B=__webpack_require__(6),C=__webpack_require__(3),ba=__webpack_require__(13),da=__webpack_require__(14),ea=__webpack_require__(15),fa=__webpack_require__(16),ia=__webpack_require__(17),D=__webpack_require__(7);
 ...
 */
var fetchLa = function fetchLa(url, context) {
...
var MainCom = function (_React$Component) {
	_inherits(MainCom, _React$Component);

	function MainCom() {
		_classCallCheck(this, MainCom);

		return _possibleConstructorReturn(this, (MainCom.__proto__ || Object.getPrototypeOf(MainCom)).call(this));
	}
		...
		value: function render() {
			return _react2.default.createElement(
				...
				_react2.default.createElement(
					'div',
					null,
					_react2.default.createElement(_reactRouterDom.Route, { path: '/', component: _Navigation2.default }),
					_react2.default.createElement(_reactRouterDom.Route, { path: '/blogList', component: _BlogList2.default }),
...
_reactDom2.default.render(_react2.default.createElement(MainCom, null), document.getElementById('lala'));
...
var _routela = __webpack_require__(77);

var _routela2 = _interopRequireDefault(_routela);
	...
	_createClass(Navigation, [{
		...
		value: function render() {
			...
			return _react2.default.createElement(
				'div',
				null,
				_react2.default.createElement(_routela2.default, { routela: this.state.pathname }),
				page
			);
		}
	}, {
...
var Routela = function (_React$Component) {
	_inherits(Routela, _React$Component);

	function Routela() {
		_classCallCheck(this, Routela);

		var _this = _possibleConstructorReturn(this, (Routela.__proto__ || Object.getPrototypeOf(Routela)).call(this));
	...
	_createClass(Routela, [{
		key: 'render',
		value: function render() {
			var word = this.props.routela,
			    dic = word.match(/\/[^\/]*/g),
			    line = [];
			for (var i = 0; i < dic.length; i++) {
				...
				if (dic[0] !== '/') {
					line.push({ name: dic[i].substring(1), route: dic.slice(0, i + 1).reduce(function (gaga, lala) {
							return gaga + lala;
						}) });
				}
			}
			var list = function list() {
				...
				return line.map(function (item, index) {
					return _react2.default.createElement(
						'li',
						{ key: item.name, style: { display: 'inline-block' } },
						_react2.default.createElement(
							_reactRouterDom.Link,
							{ to: item.route },
							item.name
...
var _ooooo = __webpack_require__(79);

var _ooooo2 = _interopRequireDefault(_ooooo);

var _caichengyu = __webpack_require__(80);

var _caichengyu2 = _interopRequireDefault(_caichengyu);

var _wenzimaoxian = __webpack_require__(81);

var _wenzimaoxian2 = _interopRequireDefault(_wenzimaoxian);
		...
		value: function render() {
			...
			if (this.state.pathname === '/game') {
				...
				return _react2.default.createElement(
					'div',
					null,
					_react2.default.createElement(_reactRouterDom.Route, { path: '/game/:id', render: function render(_ref) {
							var match = _ref.match;

							switch (true) {
								case match.params.id === 'ooooo':
									page = _react2.default.createElement(_ooooo2.default, null);
									break;
								case match.params.id === 'caichengyu':
									page = _react2.default.createElement(_caichengyu2.default, null);
									break;
								case match.params.id === 'wenzimaoxian':
									page = _react2.default.createElement(_wenzimaoxian2.default, null);
									break;
								default:
									page = '';
							}
...
var Ooooo = function (_React$Component) {
	_inherits(Ooooo, _React$Component);

	function Ooooo() {
		_classCallCheck(this, Ooooo);

		var _this = _possibleConstructorReturn(this, (Ooooo.__proto__ || Object.getPrototypeOf(Ooooo)).call(this));
...
var Caichengyu = function (_React$Component) {
	_inherits(Caichengyu, _React$Component);

	function Caichengyu() {
		_classCallCheck(this, Caichengyu);

		var _this = _possibleConstructorReturn(this, (Caichengyu.__proto__ || Object.getPrototypeOf(Caichengyu)).call(this));

		_this.state = {};
		return _this;
	}

	_createClass(Caichengyu, [{
		key: 'render',
		value: function render() {
			return _react2.default.createElement(
				'div',
...
var Wenzimaoxianu = function (_React$Component) {
	_inherits(Wenzimaoxianu, _React$Component);

	function Wenzimaoxianu() {
		_classCallCheck(this, Wenzimaoxianu);

		var _this = _possibleConstructorReturn(this, (Wenzimaoxianu.__proto__ || Object.getPrototypeOf(Wenzimaoxianu)).call(this));

		_this.state = {};
		return _this;
	}

	_createClass(Wenzimaoxianu, [{
		key: 'render',
		value: function render() {
			return _react2.default.createElement(
				'div',
	...
	return Wenzimaoxianu;
}(_react2.default.Component);

exports.default = Wenzimaoxianu;
...
var _Blog = __webpack_require__(83);
...
var BlogList = function (_React$Component) {
	...
	_createClass(BlogList, [{
		...
		value: function componentWillMount() {
			...
			this.fetchList.bind(this)(function (data) {
				_this2.setState({ listla: data });
			});
		}
	}, {
		key: 'render',
		value: function render() {
			...
			var listla = this.state.listla.map(function (item, index) {
				return _react2.default.createElement(
					'div',
					{ style: { border: 'black solid 1px', width: '100%', marginTop: '10px' }, key: index, onClick: _this3.handelEdit(item).bind(_this3) },
					_react2.default.createElement(
						'span',
						{ style: { margin: '0 10px' } },
						'title:'
					...
					_react2.default.createElement('div', { style: { width: '100%', borderBottom: '1px solid black', height: 0 } }),
					_react2.default.createElement('div', { dangerouslySetInnerHTML: { __html: item.context } })
				);
			});
			if (!this.state.editla) {
				return _react2.default.createElement(
					...
					_react2.default.createElement(
						'div',
						{ onClick: this.addCommit.bind(this) },
						'addCommit'
					),
					listla
				);
			} else {
				return _react2.default.createElement(_Blog2.default, { keyLa: this.state.keyLa, handelCom: this.handelCom.bind(this) });
			}
		}
	}, {
		key: 'fetchList',
		value: function fetchList(fnc) {
			(0, _fetch2.default)('http://127.0.0.1:5000/getCommit', {}).then(function (response) {
		...
		key: 'handelEdit',
		value: function handelEdit(item) {
			var _this4 = this;

			return function () {
				_this4.setState({ editla: true, keyLa: item });
			};
		}
	}, {
		key: 'addCommit',
		value: function addCommit() {
			this.setState({ editla: true, keyLa: this.state.listla.length });
		}
	}, {
		key: 'handelCom',
		value: function handelCom() {
			var _this5 = this;

			this.fetchList.bind(this)(function (data) {
				_this5.setState({ editla: false, listla: data });
			});
		}
	}]);
	...
	_createClass(Blog, [{
		...
		value: function render() {
			...
			return _react2.default.createElement(
				...
				_react2.default.createElement('div', { style: { border: 'dashed 2px', marginBottom: '10px' }, dangerouslySetInnerHTML: { __html: this.state.blogContent } }),
				_react2.default.createElement(
					'div',
					...
					_react2.default.createElement('input', { type: 'text', onChange: function onChange(e) {
							_this2.setState({ titleContent: e.target.value });
						}, value: this.state.titleContent })
				),
				_react2.default.createElement(_Board2.default, { id: 'content', keyLa: this.props.keyLa }),
				_react2.default.createElement(
					'div',
					{ style: { marginTop: '10px' }, onClick: this.getContent.bind(this) },
					'Content'
				),
				_react2.default.createElement(
					'div',
					{ style: { marginTop: '10px' }, onClick: this.subLa.bind(this) },
					'SubLa'
				)
			);
		}
		...
		value: function componentDidMount() {
			this.setState({ titleContent: this.props.keyLa.title });
		}
	}, {
		key: 'getContent',
		...
		key: 'subLa',
		value: function subLa() {
			var _this3 = this;

			var data = UE.getEditor('content').getContent();
			(0, _fetch2.default)('http://127.0.0.1:5000/setCommit', {
...
var Board = function (_React$Component) {
	...
	_createClass(Board, [{
		...
		value: function initEditor() {
			...
			var ueEditor = UE.getEditor(this.props.id);
			var theThis = this;
			ueEditor.ready(function (ueditor) {
				if (!ueditor) {
					...
					ueEditor.setContent(_this2.props.keyLa.context);
				}
			});
		}
	}, {
		key: "render",
		value: function render() {
			return _react2.default.createElement("div", { id: this.props.id, name: "content" });
		}
	}, {
		key: "componentDidMount",
		value: function componentDidMount() {
